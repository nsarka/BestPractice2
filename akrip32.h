...
__declspec( dllimport ) int GetNumAdapters( void );
__declspec( dllimport ) int GetCDList( LPCDLIST cd );
__declspec( dllimport ) int GetAspiLibError( void );
__declspec( dllimport ) BYTE GetAspiLibAspiError( void );

__declspec( dllimport ) DWORD GetCDId( HCDROM hCD, char *buf, int maxBuf );
__declspec( dllimport ) DWORD GetDriveInfo( BYTE ha, BYTE tgt, BYTE lun, LPCDREC cdrec );
__declspec( dllimport ) DWORD ReadTOC( HCDROM hCD, LPTOC lpToc, BOOL bMSF );
__declspec( dllimport ) DWORD ReadCDAudioLBA( HCDROM hCD, LPTRACKBUF );
__declspec( dllimport ) BOOL QueryCDParms( HCDROM hCD, int which, DWORD *pNum );
__declspec( dllimport ) BOOL ModifyCDParms( HCDROM hCD, int which, DWORD val );
__declspec( dllimport ) HCDROM GetCDHandle( LPGETCDHAND lpcd );
__declspec( dllimport ) BOOL CloseCDHandle( HCDROM );
__declspec( dllimport ) DWORD ReadCDAudioLBAEx( HCDROM hCD, LPTRACKBUF, LPTRACKBUF );
__declspec( dllimport ) DWORD GetAKRipDllVersion( void );
__declspec( dllimport ) BOOL AkripInit();
__declspec( dllimport ) void AkripDeinit();
...
__declspec( dllimport ) DWORD GetCDDBDiskID( HCDROM hCD, DWORD *pID, int numEntries );
__declspec( dllimport ) DWORD CDDBQuery( HCDROM hCD, LPCDDBQUERY lpq );
__declspec( dllimport ) DWORD CDDBGetDiskInfo( LPCDDBQUERYITEM lpq, char *szCDDBEntry, int maxLen );
__declspec( dllimport ) void CDDBSetOption( int what, char *szVal, int iVal );
__declspec( dllimport ) DWORD CDDBGetServerList( LPCDDBSITELIST lpSiteList );
__declspec( dllimport ) DWORD CDDBSubmit( DWORD dwDiscID, BOOL bTest, char *szEmail, char *szCategory,
		  char *szEntry );
