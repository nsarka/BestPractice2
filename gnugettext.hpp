...
public:
	...
	WideString __fastcall gettext(const AnsiString szMsgId)/* overload */;
	WideString __fastcall gettext(const WideString szMsgId)/* overload */;
	WideString __fastcall ngettext(const AnsiString singular, const AnsiString plural, int Number)/* overload */;
	WideString __fastcall ngettext(const WideString singular, const WideString plural, int Number)/* overload */;
	...
	WideString __fastcall dgettext(const AnsiString szDomain, const AnsiString szMsgId)/* overload */;
	WideString __fastcall dgettext(const AnsiString szDomain, const WideString szMsgId)/* overload */;
	WideString __fastcall dngettext(const AnsiString szDomain, const AnsiString singular, const AnsiString plural, int Number)/* overload */;
	WideString __fastcall dngettext(const AnsiString szDomain, const WideString singular, const WideString plural, int Number)/* overload */;
	...
	WideString __fastcall ansi2wide(const AnsiString s);
